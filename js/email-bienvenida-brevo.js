...
function esTemporadaFestiva() {
    ...
    // Desde 20 de diciembre hasta 7 de enero
    return (mes === 11 && dia >= 20) || (mes === 0 && dia <= 7);
}

/**
 * Obtener mensaje festivo si estamos en temporada
 */
function obtenerMensajeFestivo() {
    if (!esTemporadaFestiva()) return '';
