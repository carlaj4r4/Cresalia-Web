...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f7fa;">
    <div style="max-width: 600px; margin: 20px auto; background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 40px 30px; color: #333; line-height: 1.8;">
            ...
            <div style="background: #EFF6FF; border-left: 4px solid #2563EB; padding: 15px 20px; margin: 20px 0; border-radius: 4px;">
                <strong style="color: #2563EB;">${subdomain}.cresalia.com</strong>
            </div>
            ` : ''}
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="https://cresalia.com/tiendas/panel.html" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #2563EB 0%, #7C3AED 100%); color: white; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 15px rgba(37, 99, 235, 0.3);">
...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f7fa;">
    <div style="max-width: 600px; margin: 20px auto; background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 40px 30px; color: #333; line-height: 1.8;">
            ...
            <div style="background: #ECFDF5; border-left: 4px solid #10B981; padding: 15px 20px; margin: 20px 0; border-radius: 4px;">
                <strong style="color: #10B981;">${subdomain}.cresalia.com</strong>
            </div>
            ` : ''}
            <div style="background: #F9FAFB; padding: 20px; border-radius: 8px; margin: 20px 0;">
                <h3 style="color: #374151; font-size: 18px; margin-top: 0;">🎯 Próximos pasos:</h3>
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="https://cresalia.com/tiendas/panel.html" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #10B981 0%, #14B8A6 100%); color: white; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.3);">
                    🚀 Ir a Mi Panel
                </a>
            </div>
            <p style="margin-top: 30px;">Saludos cordiales,<br><strong>El equipo de Cresalia</strong> ❤️</p>
...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f4f7fa;">
    <div style="max-width: 600px; margin: 20px auto; background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 40px 30px; color: #333; line-height: 1.8;">
            ...
            <p><strong>📍 Tu perfil único:</strong></p>
            <div style="background: #FEF3C7; border-left: 4px solid #F59E0B; padding: 15px 20px; margin: 20px 0; border-radius: 4px;">
                <strong style="color: #F59E0B;">${subdomain}.cresalia.com</strong>
            </div>
            ` : ''}
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="https://cresalia.com/tiendas/panel.html" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #F59E0B 0%, #F97316 100%); color: white; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 15px rgba(245, 158, 11, 0.3);">
                    🚀 Ir a Mi Panel
                </a>
            </div>
