...
-- Crear trigger (ahora con nombre único y sin conflictos)
...
SELECT 
    ...
    'Tabla mensajes_globales creada' as mensaje,
    'Ahora podés enviar TUS mensajes personales desde PANEL-MENSAJES-ADMIN.html' as instruccion;
